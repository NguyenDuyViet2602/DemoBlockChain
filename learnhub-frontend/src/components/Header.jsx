      ...
      <div className="container flex h-16 items-center gap-4 px-6">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
          <div ref={browseRef} className="relative">
            <button onClick={() => setOpenBrowse((v) => !v)} className="hover:text-foreground transition-colors flex items-center gap-1">
              Duyệt
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <IconButton ariaLabel="Cart">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5"><path d="M6 6h15l-1.5 9h-12z"/><path d="M6 6l-2 0"/><circle cx="9" cy="21" r="1"/><circle cx="18" cy="21" r="1"/></svg>
          </IconButton>
          <IconButton ariaLabel="Notifications">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5"><path d="M6 8a6 6 0 1112 0c0 7 2 5 2 7H4c0-2 2 0 2-7"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>
          </IconButton>
          <div ref={accountRef} className="relative">
            <IconButton ariaLabel="Profile" onClick={() => setOpenAccount((v) => !v)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5"><circle cx="12" cy="8" r="4"/><path d="M6 20c0-3.3 2.7-6 6-6s6 2.7 6 6"/></svg>
            </IconButton>
            {openAccount && (
